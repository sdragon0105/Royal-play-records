...
tuneboom.config = {
  env: 'prod',
  dev: {
    baseUrl: 'https://6464534f0463.ngrok.io',
    searchUrl: `/api/tracks/_search`,
    suggestUrl: `/api/tracks/suggest`,
    collectionsUrl: `/api/collections`,
    shop: `tuneboom-2020-09-16.myshopify.com`,
  },
  prod: {
    baseUrl: 'https://app.tuneboom.io',
    searchUrl: `/api/tracks/_search`,
    suggestUrl: `/api/tracks/suggest`,
    collectionsUrl: `/api/collections`,
  }
...
tuneboom.player = {
  ...
  setPlayerDetails: function(trackId) {
    ...
    document.getElementById('title-text').innerHTML = track.title;
  ...
  searchApi: function (query, offset = 0) {
    ...
    request.onload = function () {
      ...
      facetMenu.innerHTML = Object.keys(facets)
        .sort((a,b) => facets[a].index - facets[b].index) // sort by index
    ...
    const addPaginationListener = (results, offset) => {
      $('#collection-list-pagination-button')
        .off('click')
        .on('click', () => {
            ...
            >
                ...
                <div class="price__sale">
                  ...
                  <span class="price-item-sub price-item--sale">
                     ${product.price_varies ? 'From ' + Shopify.formatMoneyTuneboom(product.price_min, window.moneyFormat || Shopify.money_format) : Shopify.formatMoneyTuneboom(product.compare_at_price, window.moneyFormat || Shopify.money_format)}
                  </span>
                    </dd>
